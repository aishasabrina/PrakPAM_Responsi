// class detail_model{
//   List<DetailMatchesModel>? detail = [];
//
//   detail_model({this.detail});
//
//   detail_model.fromJson(Map<String, dynamic> json) {
//     if (json['matches'] != null) {
//       detail = <DetailMatchesModel>[];
//       json['matches'].forEach((v) {
//         detail!.add(new DetailMatchesModel.fromJson(v));
//       });
//     }
//   }
...
//     if (this.detail != null) {
//       data['matches'] = this.detail!.map((v) => v.toJson()).toList();
//     }
//     return data;
//   }
//
