...
//
//   matches_model({this.match});
//
//   matches_model.fromJson(Map<String, dynamic> json) {
//     if (json['matches'] != null) {
//       match = <MatchesModel>[];
//       json['matches'].forEach((v) {
//         match!.add(new MatchesModel.fromJson(v));
//       });
//     }
//   }
...
//     if (this.match != null) {
//       data['matches'] = this.match!.map((v) => v.toJson()).toList();
//     }
//     return data;
//   }
//
